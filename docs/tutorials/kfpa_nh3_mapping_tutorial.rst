...
Spectral Line Calibration Observation
-------------------------------------

After submitting this script, AstrID will set the commanded configuration parameters, slew to the commanded off position and balance the system there. Observers should watch the AstrID output carefully here. The power levels of VEGAS are considered to be in range if they are within 2 dB of -20 dB (where to find these values is covered under "VEGAS Monitoring Tools" in the Observers Guide). 
