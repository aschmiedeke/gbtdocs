...
; Steps 3.2.3  here we are running the commands quietly, and then 
...
;Step 3.2.4 - clear the buffer
sclear

;Step 3.2.5; Here wer are going to loop over the scans of interest.
...
; Step 3.2.6 - fix the x-axis
setxunit,'GHz' ; make sure we have the expected units in the x-axis.
setx,1.401,1.412

; Step 3.2.7 - smooth the data to the desired resolution
gsmooth,100,/decimate

show
unfreeze
; Step 3.2.8 - Remove baseline
...
; Step 3.2.9.1: determine (and print) the rms noise
velo
...
; Step 3.2.9.2: determine the galaxy's mean intensity using method 1, and calculating the 20% and 50% velocity widths
