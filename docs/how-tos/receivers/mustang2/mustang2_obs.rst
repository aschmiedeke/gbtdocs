...
In Astrid under ObservationManagement, go to the Run tab-item and fill in the Observer and Operator information. 
...
.. hint:: 
    ...
    - Write down the weather conditions from the GbtStatus tab-item in Astrid in the observing log 
