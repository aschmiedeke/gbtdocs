...
.. grid:: 1 2 2 2
    ...
    .. grid-item-card::
        ...
        :octicon:`telescope;3em;sd-text-primary` **MUSTANG-2 Overview**

        A brief description of MUSTANG-2 and its capabilities.
   
        .. button-link:: mustang2/mustang2_overview.html
            :color: primary
            :outline:
            :click-parent:
    ...
    .. grid-item-card::
        ...
        :octicon:`people;3em;sd-text-primary` **Instrument Team**

        A list of the MUSTANG-2 instrument team members.
   
        .. button-link:: mustang2/mustang2_instrument_team.html
            :color: primary
            :outline:
            :click-parent:
...
.. grid:: 1 2 2 2
    ...
    .. grid-item-card::
        ...
        :octicon:`graph;3em;sd-text-primary` **Bandpass**

        Description MUSTANG-2's bandpass.

        .. button-link:: mustang2/mustang2_bandpass.html
            :color: primary
            :outline:
            :click-parent:
    ...
    .. grid-item-card::
        ...
        :octicon:`gear;3em;sd-text-primary` **Filtering**
    ...
    .. grid-item-card::
        ...
        .. button-link:: mustang2/mustang2_mapping.html
            :color: primary
            :outline:
            :click-parent:
...
.. grid:: 1 2 2 2
    ...
    .. grid-item-card::
        ...
        .. button-link:: mustang2/mustang2_dev.html
            :color: primary
            :outline:
            :click-parent:

            See Timeline and Photos
