...
;
; Previously shown regions are first erased and then the current
...
;       If set, the regions are turned off on the plotter and no new 
;       regions are drawn. The regions remain set in !g.regions, they
;       are simply not shown in the plotter.
;
;-
