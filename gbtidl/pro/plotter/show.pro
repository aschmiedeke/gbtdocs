...
;       a data container, or an integer global buffer number.  Defaults to
;       the primary data container (buffer 0).
;
; :Keywords:
;   color : in, optional, type=long integer, default=!g.showcolor
;       The color for the data to be plotted.
;
;   defaultx : in, optional, type=boolean
;       When defaultx is set, the reference frame, velocity definition, and 
;       units from the data header in will be used on the x-axis.  Otherwise,
;       the current plotter settings are retained.
;
;   smallheader : in, optional, type=boolean
;       When set, only a small, one line header consisting of RA, DEC, source
;       name, and date is placed at the top of the plot.  The footer line is 
;       displayed when smallheader is set. By default, the full, multi-line
;       header and the single line footer are displayed.
;
; noheader : in, optional, type=boolean
;       When set, no header information is displayed at the top of the plot or
;       below the x-axis label of the plot (footer).  This takes precedence over
;       smallheader. By default, the full, multi-line header and the single line
