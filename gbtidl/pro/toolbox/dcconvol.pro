...
;
; This allows users to convolve a data container with an
...
;       The kernel to use in the convolution.  Must have fewer elements
;       than the data container being convolved.
; 
