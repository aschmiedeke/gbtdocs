...
; used.  Use :idl:pro:`dcxshift` to align using the
...
;       by the last 4 characters of the velocity_definition in the
;       ongoing accumulation will be used.  See :idl:pro:`frame_velocity`
;       for a full list of supported reference frames.
;
;   veldef : in, optional, type=string
;       The velocity definition to use. If not supplied, the value
;       implied by the first 4 characters of the velocity_definition
;       in the ongoing accumulation will be used. See :idl:pro:`frame_velocity`
;       for a full list of supported reference frames.
;
...
;
; :Returns:
;       shift, in channels, to be used as argument to dcshift.
