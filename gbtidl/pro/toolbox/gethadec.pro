...
;
; This returns the Hour Angle and Declination as a 2-element
...
; are used as is the coordinate_mode.  If the coordinate_mode is HADEC
...
;
; :Returns:
;   vector (spectral line) or array (continuum) holding HA and DEC in 
;   degrees
;
;-
function gethadec, dc, equinox, quiet=quiet
    ...
    case dc.coordinate_mode of
        'RADEC': begin
            ...
            longaxis = ra2ha(longaxis,lst)
        end
        'GALACTIC': begin
            radec = galtoeq(longaxis, lataxis, equinox)
        ...
        'HADEC': begin
            if equinox ne dc.equinox then begin
                ; convert HA to RA
