...
; data container.
;
; A blanked value is a NaN, this returns the number of NaNs in the
...
;   size : out, optional, type=integer
;       The total number of data elements in dc (-1 if dc is an 
;       invalid data container)
; 
; :Returns:
;   The total number of blanked values in dc.  Returns -1 if dc
