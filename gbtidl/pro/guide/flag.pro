...
;
; <p>A scan number or array of scan numbers is required and can be
...
; flagged, <a href="flagrec.html">flagrec</a> may be more appropriate.
;
...
; have additional blanking applied (e.g. <a href="replace.html">replace</a>) but not flagged.
;
; <p>The sampler argument can be used to specify a specific sampler
...
;
; @param scan {in}{optional}{type=integer} M&C scan numbers to
