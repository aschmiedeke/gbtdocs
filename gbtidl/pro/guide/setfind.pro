;+
; Set a selection parameter to be used later by <a href="find.html">find</a>
;
; <p>This sets one of the fields in the structure used by FIND.  There
...
; "Find" in the 
; <a href="http://wwwlocal.gb.nrao.edu/GBT/DA/gbtidl/users_guide/node51.html" TARGET="_top">User's Guide</a> for selection syntax examples. This
...
; value.
;
; <p>See <a href="listfind.html">listfind</a> to show the current value of any of the possible 
; selection parameters used by FIND.
;
; <p><a href="clearfind.html">clearfind</a> can be used to unset selection parameters used by FIND.
;
; @param param {in}{optional}{type=string} The selection parameter to
...
; important.
;
; @param val1 {in}{optional}{type=appropriate to param} The value that
...
; FIND is used.  If not supplied, the user is asked for a value.
;
; @param val2 {in}{optional}{type=floating or integer} This is used
; with val1 to define a selection range.  If not supplied, only val1
; is used and the user is not prompted for val2.
;
; @keyword append {in}{optional}{type=boolean} When set, the selection
...
;
; @examples
; See also <a href="find.html">find</a>
;
; <pre>
...
; </pre>
;
; Note that nothing happens until you use <a href="find.html">find</a>
;
; @version $Id$
;-
