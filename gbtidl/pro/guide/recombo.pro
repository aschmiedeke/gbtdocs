...
;+
; Plot the Oxygen recombination lines for quantum jump of dN.
...
;
; where for oxygen values (MHz), :math:`R_a = 3.28972919\times 10^9`
;
; :Params:
...
pro recombo,dn,doPrint=doPrint
    ...
    idstring = '__recombo_'+strtrim(string(dn),2)
    ...
    repeat begin
        ...
        if ((xij gt xmin) && (xij lt xmax)) then begin
            ...
            linesdrawn=1
            if (doPrint) then print, 'O levels = ',i+dn,' -> ', i,' nu = ', xij
        endif
        i = i + 1
