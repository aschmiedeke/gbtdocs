...
;
; <p>Takes the data values in the data container indicated by 
...
;
; <p>The data container indicated by the 'buffer' parameter is altered
...
;
; <p>Interpolation is accomplished by using the IDL INTERPOL procedure
...
;
; <p>This procedure only works in line mode.
;
...
; </pre>
;
; @uses <a href="../toolbox/dcresample.html">dcresample</a>
