...
cgScaleVector() - Scale elements of a vector to a given data rangecgSet - Make the selected cgWindow application the "current" window
cgSet - Select the cgWindow aplication to be the "current" application
